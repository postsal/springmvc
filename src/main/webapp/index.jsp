...
<div id="fh5co-page">
    ...
    <div id="fh5co-featured-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <a href="#" class="featured-grid" style="background-image: url(/assets/images/image_6.jpg);">
                        <div class="desc">
                ...
                <div class="col-md-6">
                    <a href="#" class="featured-grid featured-grid-2" style="background-image: url(/assets/images/image_2.jpg);">
                        <div class="desc">
                            <h3>Music Lover</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="#" class="featured-grid featured-grid-2" style="background-image: url(/assets/images/image_3.jpg);">
                                <div class="desc">
                                    <h3>Travel</h3>
                        ...
                        <div class="col-md-6">
                            <a href="#" class="featured-grid featured-grid-2" style="background-image: url(/assets/images/image_8.jpg);">
                                <div class="desc">
                                    <h3>Captured</h3>
                                    <span>Photo</span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    <div class="blog-inner">
                        <a href="#"><img class="img-responsive" src="/assets/images/image_4.jpg" alt="Blog"></a>
                        <div class="desc">
                ...
                <div class="col-md-4 text-center">
                    <div class="blog-inner">
                        <a href="#"><img class="img-responsive" src="/assets/images/image_5.jpg" alt="Blog"></a>
                        <div class="desc">
                ...
                <div class="col-md-4 text-center">
                    <div class="blog-inner">
                        <a href="#"><img class="img-responsive" src="/assets/images/image_6.jpg" alt="Blog"></a>
                        <div class="desc">

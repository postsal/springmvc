    ...
    <div class="blog">
        <div class="blog-left">
            <div class="blog-left-grid">
                ...
                <div class="clearfix"> </div>
                <a href="single.html"><img src="/assets/images/4.jpg" alt=" " class="img-responsive" /></a>
            ...
            <div class="blog-left-grid">
                ...
                <div class="clearfix"> </div>
                <a href="single.html"><img src="/assets/images/5.jpg" alt=" " class="img-responsive" /></a>
                <p class="para"> Itaque earum rerum hic tenetur a sapiente delectus,
                    ut aut reiciendis voluptatibus maiores alias consequatur aut
                    perferendis doloribus asperiores repellat.Et harum quidem rerum
                    facilis est et expedita distinctio. Nam libero tempore, cum
        ...
        <div class="blog-right">
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    ...
                    <div class="resp-tabs-container">
                        <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                            <div class="facts">
                                <div class="tab_list">
                                    <a href="/assets/images/7-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                            ...
                            <div class="facts">
                                <div class="tab_list">
                                    <a href="/assets/images/8-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                            ...
                            <div class="facts">
                                <div class="tab_list">
                                    <a href="/assets/images/9-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                            ...
                            <div class="facts">
                                <div class="tab_list">
                                    <a href="/assets/images/10-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
            ...
            <div class="four-fig">
                <div class="four-fig1">
                    <a href="/assets/images/11-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="/assets/images/11.jpg" class="img-responsive" alt=" " />
                    </a>
                </div>
                <div class="four-fig1">
                    <a href="/assets/images/14-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="/assets/images/14.jpg" class="img-responsive" alt=" " />
                    </a>
                </div>
                <div class="four-fig1">
                    <a href="/assets/images/10-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="/assets/images/21.jpg" class="img-responsive" alt=" " />
                    </a>
                </div>
                <div class="four-fig1">
                    <a href="/assets/images/8-.jpg" class="b-link-stripe b-animate-go   swipebox"  title="">
                        <img src="/assets/images/22.jpg" class="img-responsive" alt=" " />
                    </a>
                </div>
                <div class="clearfix"> </div>
            </div>
